                ...
                <div className="mt-8 flex flex-col items-center">
                  <p className="text-base lg:text-lg font-body text-gray-800 font-normal px-8 -mb-2 leading-normal tracking-wide">
                    ...
                    <span className="line-through">
                      {" "}
                      Sending your information to your educational institution
                      has been Your account is active after you are verified by
                      calling to do{" "}
                    </span>{" "}
                    Email will be sent to you. Please check your email. Or you
                    are currently independent of educational institutions You
                    can enjoy all the facilities by registering.
                  </p>
