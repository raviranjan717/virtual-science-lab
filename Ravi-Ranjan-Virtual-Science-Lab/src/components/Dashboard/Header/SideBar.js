      ...
      >
        ...
        <div>
          ...
          <ul className="mt-4">
            ...
            <li
              className={`px-3 py-2 rounded-sm mb-3 last:mb-0 ${
                page === "labroom" && "bg-dark-brand-900"
              }`}
            >
              <NavLink
                exact
            ...
            >
              <div
                ...
                className={`block cursor-pointer text-gray-200 hover:text-indigo-200 transition duration-150 ${
                  page.startsWith("simulation-") && "hover:text-gray-200"
                }`}
              >
            ...
            <li
              className={`px-3 py-2 rounded-sm mb-3 last:mb-0 ${
                page === "community" && "bg-dark-brand-900"
              }`}
            >
              <NavLink
                exact
            ...
            <li
              className={`px-3 py-2 rounded-sm mb-3 last:mb-0 ${
                page === "messages" && "bg-dark-brand-900"
              }`}
            >
              <NavLink
                exact
            ...
            <li
              className={`px-3 py-2 rounded-sm mb-3 last:mb-0 ${
                page === "workshop" && "bg-dark-brand-900"
              }`}
            >
              <NavLink
                exact
            ...
            <li
              className={`px-3 py-2 rounded-sm mb-3 last:mb-0 ${
                page === "noticeboard" && "bg-dark-brand-900"
              }`}
            >
              <NavLink
                to="/noticeboard"
